...
admin.site.site_header = "RPA"
admin.site.site_title = "RPA Admin Portal"
admin.site.index_title = "RPA Admin"
...
schema_view = get_schema_view(
    openapi.Info(
        title="RPA API",
        default_version="v1",
        description="API documentation for RPA App",
    ),
    public=True,
